...
const switchLoopingGameScenes = ({ id, gameState, command }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (return_game_looping_conditions_1.returnGameLoopingConditions.condition1Right({ id, command, gameState })) {
    ...
    else if (return_game_looping_conditions_1.returnGameLoopingConditions.condition3Default({ id, command, gameState })) {
        if (return_game_looping_conditions_1.returnGameLoopingConditions.condition3Right({ id, command, gameState })) {
        ...
        return_game_looping_conditions_1.returnGameLoopingConditions.condition3Wrong({ id, command, gameState })) {
            goToSpecificGameSceneCommand = (0, hex_transform_utilities_1.transformToHexArray)(SpecificGameScene("goToLoopingModeScene1"));
            scene = 1;
            cursorPosition = 1;
            maxCursorPositions = 4;
