...
function createStageList(conditionsObject) {
    ...
    conditionsObject.right.forEach((condition) => {
        sceneValues.insertAdjacentHTML("beforeend", `<div>${condition.scene}</div>`);
        conditionValues.insertAdjacentHTML("beforeend", `<div class="condition-value">
...
function bindEventListeners() {
    Object.keys(encodersObject).forEach((encoder) => {
        encodersObject[encoder].addEventListener("mousedown", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const response = yield gameApi(guiStore[encoder].command);
    ...
    Object.keys(buttonsObject).forEach((button) => {
        buttonsObject[button].addEventListener("mousedown", function () {
            return __awaiter(this, void 0, void 0, function* () {
                const response = yield gameApi(guiStore[button].command);
                wrightDataToControlPanel({ response });
                wrightDataToView({ response });
            });
        });
