...
const gameSubController = ({ id, command }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    gameState.mode === store_types_1.EGameModes.mna) {
        ...
        if (return_game_mna_conditions_1.returnGameMnaConditions.mnaValidInterfaces({ command }) && return_game_mna_conditions_1.returnGameMnaConditions.notLastScenes() || gameState.messageStatus === 1) {
    ...
    gameState.mode === store_types_1.EGameModes.sod) {
        ...
        if (return_game_sod_conditions_1.returnGameSodConditions.sodValidInterfaces({ command }) && return_game_sod_conditions_1.returnGameSodConditions.notLastScenes() || gameState.messageStatus === 1) {
            if (gameState.messageStatus === 0) {
    ...
    gameState.mode === store_types_1.EGameModes.looping) {
        ...
        if (return_game_looping_conditions_1.returnGameLoopingConditions.loopingValidInterfaces({ command }) && return_game_looping_conditions_1.returnGameLoopingConditions.notLastScenes() || gameState.messageStatus === 1) {
            if (gameState.messageStatus === 0) {
